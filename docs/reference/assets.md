...
作品牆由 `scripts/build.mjs` 先排列 `content/site.json` 的 `featured`，再接其餘作品。現有精選順序為 `animation-02`、`chibi-03`、`chibi-31`、`animation-03`、`chibi-02`、`chibi-35`。首屏展示則固定為 `chibi-01`、`animation-02`、`animation-01`，不由精選陣列自動產生。

建置另加入 `stickers-01` 貼圖總覽，因此作品牆分類件數為全部 95、角色動畫 37、小動圖 57、貼圖 1；「貼圖 1」代表一張總覽，不代表只有一款可委託。
