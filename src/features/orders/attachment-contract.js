...
export const ATTACHMENT_TYPES = ["image/png", "image/jpeg", "image/gif", "image/webp", "image/avif"];
...
export function attachmentFileError(file, imagesOnly = false) {
  ...
  if (imagesOnly && !ATTACHMENT_TYPES.includes(file.type)) return "貼圖包請上傳 PNG、JPEG、GIF、WebP 或 AVIF 圖片。";
  return "";
}
