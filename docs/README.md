...
- [2026-09-24 作品實際流程驗收](records/artwork-flow-2026-09-24.md)：操作列裁切修正、正式草稿與預覽、發布鏈及 Google 結果遺失接續。
- [2026-09-24 LanLan Pages Drive 資源整理](records/drive-storage-2026-09-24.md)：指定父目錄、作品暫存搬移、附件相容檢查與後續維護規則。
