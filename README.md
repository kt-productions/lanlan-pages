...
- [作品管理與發布](docs/development/artwork-service.md)：已正式啟用草稿、Drive 暫存、main 保存核對與 production 發布流程；完成的雲端驗證與待驗收項目見[啟用紀錄](docs/records/artwork-activation-2026-09-24.md)。
